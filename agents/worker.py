...
while True:
    ...
    • Extract issue key from URL: atlassian.net/browse/PROJ-123 → issue key "PROJ-123"
    • First call getAccessibleAtlassianResources to get your cloudId, then use it in subsequent calls
    • Search: searchJiraIssuesUsingJql with JQL query (e.g. "project=PROJ AND status='To Do'")
